...
# ================= 1. 路径全局配置 =================
ROOT_MAP_DIR = r"E:\映射"
ROOT_POP_DIR = r"E:\城市建筑_AOI_小区_POI_用途分类_人口结构_version4"
ROOT_OUTPUT_DIR = r"E:\GeiMingHao_all\GeiMingHao\result\对比\Result_Analysis"
ROOT_SCENARIO_BASE = r"E:\GeiMingHao_all\GeiMingHao\result\对比\SET_Hourly_27_2"

# EPW 气象文件基础路径 和 目标图片保存路径
EPW_ROOT_DIR = r"C:\Users\31080\Desktop\zhongzi1"
TARGET_FIG_DIR = r"C:\Users\31080\Desktop\figure\图2"
...
CITY_CONFIGS = [
    ...
    {"pinyin": "shang4hai3shi4", "chn_name": "上海市", "en_name": "Shanghai", "code": "310000",
     ...
     "custom_filename": "T310000_上海市_building_pop.csv"},
    ...
    {"pinyin": "xia4men2shi4", "chn_name": "厦门市", "en_name": "Xiamen", "code": "350200",
     ...
     "custom_filename": "T350200_厦门市_building_pop.csv"}
]
...
def process_city_data(city_conf):
    ...
    file_pop = os.path.join(ROOT_POP_DIR, prov_folder, pop_filename)

    if not os.path.exists(file_map) or not os.path.exists(file_pop):
        alt_pop = os.path.join(ROOT_POP_DIR, prov_folder, f"{code}_{chn_name}_building_pop_attributes.csv")
