...
class CONFIG:
    ...
    output_dir = r"C:\Users\31080\Desktop\figure\图22_北京_配色修改" 
    
    weibo_csv = r"E:\cn_北京&上海&广东_6-8月\北京市\北京城区\data.csv"
    sim_shp_path = r"E:\城市建筑_AOI_小区_POI_用途分类_人口结构_version4\110000北京市\T110000_北京市_building_pop.shp"
    sim_csv_path = r"E:\GeiMingHao_all\GeiMingHao\zhibiao\北京市_zhibiao_result_all.csv"
    shp_base = r"E:\中国标准地图-审图号GS(2024)0650号-shp格式\面格式\中国_县_Albers.shp"
...
# 初始化环境与输出路径
os.environ['PROJ_LIB'] = CONFIG.proj_path
os.environ['PROJ_DATA'] = CONFIG.proj_path
import pyproj
if hasattr(pyproj.datadir, 'set_data_dir'):
    pyproj.datadir.set_data_dir(CONFIG.proj_path)
...
print(f"🎉 科学严谨的独立图例 (含 Colorbar) 已生成！请查看：{leg_save_path}")