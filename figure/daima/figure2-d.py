...
OUTPUT_DIR = r"C:\Users\31080\Desktop\figure\图22"

# ==================== 0. 基础配置与城市中心坐标 ====================
# ！！！ 请确保这里的路径与您本地一致 ！！！
COUNTY_SHP_PATH = r"E:\中国标准地图-审图号GS(2024)0650号-shp格式\面格式\中国_县_Albers.shp" 
...
CUSTOM_LABELS = ['<5', '5 - 20', '20 - 40', '40 - 80', '80 - 160', '>160']
